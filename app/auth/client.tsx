...
export default function Client({ redirectTo, flashStatus, flashMessage }: ClientProps) {
  ...
  const content = useMemo(() => {
    ...
    if (mode === "signup") {
      return {
        id: "signup",
        title: "Create Your StreamForge Account",
        description: "Start building your streaming library",
    ...
    return {
      id: "signin",
      title: "Sign In to StreamForge",
      description: "Access your streaming dashboard",
      button: "Sign In",
      helper: (
        <span>
          New to StreamForge?{" "}
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <p className="max-w-md text-sm text-muted-foreground">
                Curate, host, and share your video content in a branded streaming dashboard.
              </p>
            </div>
            ...
            <div className="relative overflow-hidden rounded-2xl border border-secondary/70 bg-background/80 p-3 shadow-lg">
              <Image
                src="/demo-img.jpg"
                alt="StreamForge product preview"
